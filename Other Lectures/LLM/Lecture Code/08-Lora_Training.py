...
training_args = TrainingArguments(output_dir="peft-lora-gptj",evaluation_strategy="steps",eval_steps=10,save_steps=10,
...
trainer.save_model("peft-lora-gptj-checkpoint")
