...
explainer_rf = shap.TreeExplainer(model_rf, data=X_train_rf,feature_perturbation='interventional')
...
explainer_xgb = shap.TreeExplainer(model_xgb, data=X_train_xgb,feature_perturbation='interventional')
