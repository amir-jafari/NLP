...
#%%---------------------------------------------------------------------------------------------------------------------
X_sub, _, y_sub, _ = train_test_split(full_train.data,full_train.target,test_size=0.8,random_state=42)
...
#%%---------------------------------------------------------------------------------------------------------------------
exp_lr = explainer.explain_instance(test_text,predict_proba_lr,num_features=6,top_labels=2)
...
#%%---------------------------------------------------------------------------------------------------------------------
exp_rf = explainer.explain_instance(test_text,predict_proba_rf,num_features=6,top_labels=2)
...
for feat, weight in exp_rf.as_list(label=pred_label_rf):
    print(f"{feat:<20} weight={weight:.3f}")
#%%---------------------------------------------------------------------------------------------------------------------
exp_xgb = explainer.explain_instance(test_text,predict_proba_xgb,num_features=6,top_labels=2)
