...
def ask_question(query, chunks, bedrock_client, embedding_model_id, lm_model_id, index):
    ...
    if query_vector:
        ...
        body_content = {
            ...
            "max_tokens": 10000,  # Limit the number of tokens in the response
            "temperature": 1,
            "messages": [
...
def main():
    ...
    # Ask a question
    question = "Just answer the question. No more details needed. What is the percentage of right rate among relevant population in every region?"
...
# question = "What do you focus on empirical section in the document?"
